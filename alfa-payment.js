!function(e, t) {
    ...
    return function(e) {
        ...
        var s, f, l, d, p, h, y, v, m, _, b = r(88), g = o(b), E = r(91), O = r(111), w = o(O), T = r(138), A = o(T), R = r(139), x = o(R), j = r(140), S = o(j), P = r(141), D = o(P), L = r(142), C = o(L), k = r(143), M = o(k), U = r(149), z = o(U), I = r(152), F = o(I), H = r(175), N = o(H), B = r(176), q = n(B), K = (_ = m = function() {
            ...
            return e.getScriptElement = function() {
                ...
                n = r.indexOf("quota has been exceeded") >= 0 || r.indexOf("QuotaExceededError") >= 0 ? "Ð”Ð»Ñ Ð²Ð¾Ð·Ð¼Ð¾Ð¶Ð½Ð¾ÑÑ‚Ð¸ Ð¾Ð¿Ð»Ð°Ñ‚Ñ‹ Ð²Ñ‹ÐºÐ»ÑŽÑ‡Ð¸Ñ‚Ðµ Ñ€ÐµÐ¶Ð¸Ð¼ Â«Ð§Ð°ÑÑ‚Ð½Ñ‹Ð¹ Ð´Ð¾ÑÑ‚ÑƒÐ¿Â»" : r || "unknown exception", 
	 ...
	 */
        ...
        var r = t.ERROR_MESSAGE = {
            ru: "ÐžÐ¿Ð»Ð°Ñ‚Ð° ÐºÐ°Ñ€Ñ‚Ð¾Ð¹ Ð²Ñ€ÐµÐ¼ÐµÐ½Ð½Ð¾ Ð½ÐµÐ²Ð¾Ð·Ð¼Ð¾Ð¶Ð½Ð°, Ð¾Ð±Ñ€Ð°Ñ‚Ð¸Ñ‚ÐµÑÑŒ Ðº Ð°Ð´Ð¼Ð¸Ð½Ð¸ÑÑ‚Ñ€Ð°Ñ‚Ð¾Ñ€Ñƒ Ð¼Ð°Ð³Ð°Ð·Ð¸Ð½Ð°.",
            en: "Card payment is temporarily unavailable",
            ua: "ÐžÐ¿Ð»Ð°Ñ‚Ð° ÐºÐ°Ñ€Ñ‚ÐºÐ¾ÑŽ Ñ‚Ð¸Ð¼Ñ‡Ð°ÑÐ¾Ð²Ð¾ Ð½ÐµÐ¼Ð¾Ð¶Ð»Ð¸Ð²Ð°",
            de: "Die Kartenzahlung ist vorÃ¼bergehend nicht verfÃ¼gbar",
            fr: "Le paiement par carte est temporairement indisponible",
            es: "El pago con tarjeta no estÃ¡ disponible temporalmente",
            kz: "ÐšÐ°Ñ€Ñ‚Ð°Ð½Ñ‹ Ñ‚Ó©Ð»ÐµÑƒ ÑƒÐ°Ò›Ñ‹Ñ‚ÑˆÐ° Ð¼Ò¯Ð¼ÐºÑ–Ð½ ÐµÐ¼ÐµÑ",
            it: "Il pagamento con la carta Ã¨ temporaneamente non disponibile"
        }, n = t.BUTTON_TEXT = {
            ru: "ÐžÐ¿Ð»Ð°Ñ‚Ð¸Ñ‚ÑŒ ÐºÐ°Ñ€Ñ‚Ð¾Ð¹",
            en: "Payment",
            ua: "Ð¡Ð¿Ð»Ð°Ñ‚Ð¸Ñ‚Ð¸",
            de: "Bezahlen",
            fr: "Paiement",
            ...
            kz: "Ð¢Ó©Ð»ÐµÑƒ",
            it: "Pagare"
        }, o = t.NOT_PAYED = "Ð—Ð°ÐºÐ°Ð· Ð½Ðµ Ð¾Ð¿Ð»Ð°Ñ‡ÐµÐ½", i = t.ERROR_REQUIRE_AMOUNT = "ÐŸÐ¾Ð»Ðµ ÑÑƒÐ¼Ð¼Ð° Ð½Ðµ Ð·Ð°Ð¿Ð¾Ð»Ð½ÐµÐ½Ð¾", a = t.ERROR_REQUIRE = "ÐÐµÐ¾Ð±Ñ…Ð¾Ð´Ð¸Ð¼Ð¾ Ð·Ð°Ð¿Ð¾Ð»Ð½Ð¸Ñ‚ÑŒ Ð¾Ð±ÑÐ·Ð°Ñ‚ÐµÐ»ÑŒÐ½Ñ‹Ðµ Ð¿Ð¾Ð»Ñ";
        (function() {
